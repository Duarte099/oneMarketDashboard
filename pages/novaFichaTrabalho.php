                                                ...
                                                for ($j=1; $j <= 10; $j++) { 
                                                    ...
                                                    <?php if ($j == 1 || $j <= $numProducts) { ?>
                                                        <tbody class="produtos">
                                                            <tr>
                                                                <?php 
                                                                    $sql = "SELECT refProduct, nameProduct, amountProduct, descriptionProduct FROM budget_sections_products WHERE budget_sections_products.idbudget = $idBudget AND orderProduct = '$j' AND orderSection = '$i';";
                                                                    $result = $con->query($sql);
                                                                    if ($result->num_rows > 0) {
