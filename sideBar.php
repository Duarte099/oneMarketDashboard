...
<div class="sidebar">
    ...
    <ul class="side-menu">
        ...
        <li class="mobile-only">
            <a href="indexLogout.php"><i class='bx bx-log-out'></i>Logout</a>
        </li>
    </ul>
